...
def run_simulation(filename, geometry=(800, 600), theta=0.5, dt=0.001):
    ...
    # Précompile le noyau numba avant d'entrer dans la boucle graphique.
    # Sinon, le premier appel depuis le visualiseur bloque l'interface pendant
    # la compilation JIT et donne l'impression que la fenêtre est figée.
    update_positions_(
        dt,
        system.box.copy(),
        system.positions.copy(),
        system.velocities.copy(),
        system.masses,
        system.theta,
    )
