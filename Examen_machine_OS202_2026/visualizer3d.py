...
class Visualizer3D:
    ...
    def __init__(self, points, colors, luminosities, bounds):
        ...
        self._init_sdl()
        self._init_opengl()
        # Les client arrays/VBO via PyOpenGL posent problème sur certains pilotes.
        # On garde un rendu immédiat plus compatible pour les scripts d'examen.
        # Ancienne initialisation VBO conservée à titre de référence :
        # self._init_vbo()
    ...
    def _init_sdl(self):
        ...
        # Rend le contexte courant pour que PyOpenGL puisse résoudre les appels GL.
